        ---
        title: "Agent Calling Agent Tutorial"
        example_slug: agent-calling-agent
        capabilities: [ai-agents, workflows]
        sdks: [python-service]
        difficulty: advanced
        ...
        **Difficulty:** 🔴 Advanced  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2025-07-20

        **Capabilities demonstrated:** [ai-agents](../../capabilities/ai-agents.md) [workflows](../../capabilities/workflows.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/agent-calling-agent-tutorial){ .md-button }
