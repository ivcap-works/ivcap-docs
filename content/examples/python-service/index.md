        ---
        title: "Python Service Example"
        example_slug: python-service
        ...
        **Difficulty:** 🟢 Beginner  ·  **SDK:** `python-service` · ⭐ 1  ·  **Updated:** 2024-09-09

        **Capabilities demonstrated:** [build-services](../../capabilities/build-services.md) [artifacts](../../capabilities/artifacts.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-python-service-example){ .md-button }
