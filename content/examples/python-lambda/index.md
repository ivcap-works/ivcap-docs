        ---
        title: "Lambda Service Example"
        example_slug: python-lambda
        capabilities: [build-services]
        sdks: [python-service]
        difficulty: beginner
        ...
        **Difficulty:** 🟢 Beginner  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2024-08-21

        **Capabilities demonstrated:** [build-services](../../capabilities/build-services.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-python-lambda-example){ .md-button }
