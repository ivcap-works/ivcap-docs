        ...
        example_slug: collection-example
        capabilities: [build-services, data-fabric]
        sdks: [python-service]
        ...
        **Difficulty:** 🟡 Intermediate  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2024-11-03

        **Capabilities demonstrated:** [build-services](../../capabilities/build-services.md) [data-fabric](../../capabilities/data-fabric.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-python-service-example-collection){ .md-button }
