        ...
        example_slug: crewai-service
        capabilities: [ai-agents, build-services]
        sdks: [python-service]
        difficulty: advanced
        ...
        **Difficulty:** 🔴 Advanced  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2026-05-25

        **Capabilities demonstrated:** [ai-agents](../../capabilities/ai-agents.md) [build-services](../../capabilities/build-services.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-crewai-service){ .md-button }
...
[Run and test locally](#step4). We can use the same test request `two_bp.json`.
