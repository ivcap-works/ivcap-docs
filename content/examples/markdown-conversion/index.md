        ...
        example_slug: markdown-conversion
        capabilities: [ai-agents, artifacts]
        sdks: [python-service]
        ...
        **Difficulty:** 🟡 Intermediate  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2025-07-24

        **Capabilities demonstrated:** [ai-agents](../../capabilities/ai-agents.md) [artifacts](../../capabilities/artifacts.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-markdown-conversion-service){ .md-button }
