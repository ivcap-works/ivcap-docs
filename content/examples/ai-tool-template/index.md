        ...
        **Difficulty:** 🟡 Intermediate  ·  **SDK:** `python-service` · ⭐ 0  ·  **Updated:** 2026-02-10

        **Capabilities demonstrated:** [ai-agents](../../capabilities/ai-agents.md) [build-services](../../capabilities/build-services.md)

        [:material-github: View full repo on GitHub](https://github.com/ivcap-works/ivcap-python-ai-tool-template){ .md-button }
